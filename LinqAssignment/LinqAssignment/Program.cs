...
public class Program
{
    ...
    public void Task1()
    {
        ...
        var totalsalary = from salary in salaryList
        ...
        var Q1 = from employee in employeeList
        ...
        foreach (var item in Q1)
        {
         ...
         Console.WriteLine($" Name: {item.e.EmployeeFirstName} {item.e.EmployeeLastName},     Total Salary: {item.salary}  ");
    ...
    public void Task2()
    {
       ...
       Console.WriteLine(" TASK 2 : \n");
        ...
        var monthlySalary = from salary in salaryList
                 where salary.Type == SalaryType.Monthly
                 select salary;

        var Q2 = from salary in monthlySalary
        ...
        foreach (var item in Q2.Skip(1).Take(1))
        {
    ...
    public void Task3()
    {
        ...
        var Avg = from salary in this.salaryList
                    group salary by salary.EmployeeID
                    into sal
                    select new
                    {
        ...
        var ageG = (from employee in employeeList
                      where employee.Age > 30
                      select employee);

        var Q3 = from employee in ageG
                     join salary in Avg
                       on employee.EmployeeID
                       equals
                       salary.EmployeeID
        ...
        {
            Console.WriteLine($" EmployeeID: {item.emp.EmployeeID},      Name: {item.emp.EmployeeFirstName} {item.emp.EmployeeLastName},      Age: {item.emp.Age},    Mean salary: {item.avg:N2}");
